...
volatile unsigned int *Base_Addr =  0x10003070;
// mouse variables
int flag_plot = 0;
int N = 20;
int echo = 0;
...
void check_KEYs(alt_up_pixel_buffer_dma_dev *, int *, int *, int *, int *, alt_up_parallel_port_dev *, alt_up_audio_dev *);
...
void plot_audio(alt_up_pixel_buffer_dma_dev *, unsigned int);
